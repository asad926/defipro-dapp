...
import "../components/Card_style.css";
      ...
      <div className="homePage-card1">
        <div className="homePage-card1-bg p-4">
          <div className="d-flex justify-content-between mb-5">
            ...
            <h5 className="card_heading_text">DEFIPRO AI - CAKE</h5>
          </div>
          <div className="d-flex justify-content-between mb-2">
            <span className="homePage-card1-titles">APY</span>
            <div>
              <img src={CALCULATOR} alt="" className="me-3" />
              <span className="homePage-card1-values">92.79%-167.56%</span>
            </div>
          </div>
          <div className="d-flex justify-content-between mb-2">
            <span className="homePage-card1-titles">Farms</span>
            <span className="homePage-card1-values">CAKE</span>
          </div>
          <div className="d-flex justify-content-between mb-2">
